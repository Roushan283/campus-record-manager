...
Locate the CliManager.java file in the edu.ccrm.cli package.
Right-click on the CliManager.java file and select Run As > Java Application.
The application will start running in the Eclipse console.
Windows JDK Installation Steps
Download the Java JDK installer for Windows from the official Oracle website.
Run the installer and follow the on-screen instructions.
After installation, configure the JAVA_HOME and Path environment variables to point to your JDK installation directory (e.g., C:\Program Files\Java\jdk-21).
Verify the installation by opening a Command Prompt and running java -version.
Eclipse IDE Project Setup
Launch Eclipse IDE and choose a workspace directory.
Go to File > New > Java Project.
Enter a project name (e.g., CCRM) and select the appropriate JRE version (e.g., JavaSE-21).
Click Finish. The project will be created and will appear in the "Package Explorer".
Java Core Concepts
